...
public class Constants {
	...
	public static final String NOTIFICATION_LISTENER_SERVICE = "com.pro.deepak.NOTIFICATION_LISTENER_SERVICE";
	public static final String NOTIFICATION_LISTENER = "com.pro.deepak.NOTIFICATION_LISTENER";
