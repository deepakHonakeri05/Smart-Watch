...
PROGMEM const char* const weekString[] = {"", "SUN", "MON", "TUE", "WED", "THUR", "FRI", "SAT"};
...
// iWatch splash screen
void drawStartUp() {
  display.clearDisplay();
  display.drawBitmap(57,7,ICON_BITMAP_3,16,16,WHITE); // Boot - Apple Logo
  display.display();
  delay(4100);
 
  display.clearDisplay();

//  display.drawBitmap(50,5, IMG_logo_24x24, 24, 24, WHITE);
...
//    display.display();
  ...
  // CLOCK_STYLE_SIMPLE_MIX
    ...
    display.drawCircle(centerY, centerY, iRadius - 3, WHITE);
    ...
    if(iMinutes < 10)
      display.print("0");
    display.println(iMinutes);
    display.drawBitmap(110,16,ICON_BITMAP_12,16,16,WHITE);  //insta Logo
